...
public class WRBParser extends Parser {
	...
	public final RunContext run() throws RecognitionException {
		...
		try {
			...
			do {
				{
				{
				setState(8); ((RunContext)_localctx).s = statement();
				}
				}
				setState(11); 
				_errHandler.sync(this);
	...
	public final StatementContext statement() throws RecognitionException {
		...
		try {
			...
			case 1:
				enterOuterAlt(_localctx, 1);
				{
				setState(15); ((StatementContext)_localctx).exp = expr(0);
			...
			while ( _alt!=2 && _alt!=org.antlr.v4.runtime.atn.ATN.INVALID_ALT_NUMBER ) {
				if ( _alt==1 ) {
					...
					case 1:
						...
						setState(38); match(MUL);
						setState(39); ((ExprContext)_localctx).mul2 = expr(5);
					...
					case 2:
						...
						setState(44); ((ExprContext)_localctx).div2 = expr(4);
					...
					case 3:
						...
						setState(48); match(ADD);
						setState(49); ((ExprContext)_localctx).sum2 = expr(3);
					...
					case 4:
						...
						setState(54); ((ExprContext)_localctx).sub2 = expr(2);
	...
	public final AssignContext assign() throws RecognitionException {
		...
		try {
			...
			case 1:
				enterOuterAlt(_localctx, 1);
				{
				setState(62); ((AssignContext)_localctx).i = match(ID);
				setState(63); match(ASSIGN);
				setState(64); ((AssignContext)_localctx).exp = expr(0);
			...
			case 2:
				enterOuterAlt(_localctx, 2);
				{
				setState(67); ((AssignContext)_localctx).i = match(ID);
				setState(68); match(ASSIGN);
				setState(69); ((AssignContext)_localctx).j = match(ID);
	...
	public static final String _serializedATN =
		...
		"\5\3\5\5\5J\n\5\3\5\2\3\6\6\2\4\6\b\2\2Q\2\13\3\2\2\2\4\31\3\2\2\2\6%"+
		"\3\2\2\2\bI\3\2\2\2\n\f\5\4\3\2\13\n\3\2\2\2\f\r\3\2\2\2\r\13\3\2\2\2"+
		"\r\16\3\2\2\2\16\17\3\2\2\2\17\20\b\2\1\2\20\3\3\2\2\2\21\22\5\6\4\2\22"+
		"\23\7\f\2\2\23\24\b\3\1\2\24\32\3\2\2\2\25\26\5\b\5\2\26\27\7\f\2\2\27"+
		"\32\3\2\2\2\30\32\7\f\2\2\31\21\3\2\2\2\31\25\3\2\2\2\31\30\3\2\2\2\32"+
		"\5\3\2\2\2\33\34\b\4\1\2\34\35\7\3\2\2\35&\b\4\1\2\36\37\7\4\2\2\37&\b"+
		"\4\1\2 !\7\t\2\2!\"\5\6\4\2\"#\7\n\2\2#$\b\4\1\2$&\3\2\2\2%\33\3\2\2\2"+
		"%\36\3\2\2\2% \3\2\2\2&=\3\2\2\2\'(\f\6\2\2()\7\6\2\2)*\5\6\4\7*+\b\4"+
		"\1\2+<\3\2\2\2,-\f\5\2\2-.\7\7\2\2./\5\6\4\6/\60\b\4\1\2\60<\3\2\2\2\61"+
		"\62\f\4\2\2\62\63\7\5\2\2\63\64\5\6\4\5\64\65\b\4\1\2\65<\3\2\2\2\66\67"+
		"\f\3\2\2\678\7\b\2\289\5\6\4\49:\b\4\1\2:<\3\2\2\2;\'\3\2\2\2;,\3\2\2"+
		"\2;\61\3\2\2\2;\66\3\2\2\2<?\3\2\2\2=;\3\2\2\2=>\3\2\2\2>\7\3\2\2\2?="+
		"\3\2\2\2@A\7\4\2\2AB\7\13\2\2BC\5\6\4\2CD\b\5\1\2DJ\3\2\2\2EF\7\4\2\2"+
		"FG\7\13\2\2GH\7\4\2\2HJ\b\5\1\2I@\3\2\2\2IE\3\2\2\2J\t\3\2\2\2\b\r\31"+
		"%;=I";
